...
namespace DVDQCC
{
    public partial class MainForm : Form
    {
        ...
        private void button_set_dgindex_directory(object sender, EventArgs e)
        {
            var fileContent = string.Empty;
            var filePath = string.Empty;
        ...
        private void button_save_app_settings(object sender, EventArgs e)
        {
            var MyIni = new IniFile("settings.ini");
        ...
        private void button_singlefile_select_source_file(object sender, EventArgs e)
        {
            var fileContent = string.Empty;
            var filePath = string.Empty;
            var MyIni = new IniFile("settings.ini");
            var sdr7_mod_location = MyIni.Read("Last Single-File Source");
            ...
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MyIni.Write("Last Single-File Source", folderName);
                }
            }
        }

        private void button_singlefile_select_output_folder(object sender, EventArgs e)
        {
            var fileContent = string.Empty;
            var filePath = string.Empty;
            var MyIni = new IniFile("settings.ini");
            var sdr7_output = MyIni.Read("Last Single-File Output");
            ...
            if (sf.ShowDialog() == DialogResult.OK)
            {
                ...
                MyIni.Write("Last Single-File Output", savePath);
            }
        }

        private void button_batch_select_input_folder(object sender, EventArgs e)
        {
            var fileContent = string.Empty;
            var filePath = string.Empty;
            var MyIni = new IniFile("settings.ini");
            var batch_files_loc = MyIni.Read("Last Batch Source");
            ...
            using (var fbd = new FolderBrowserDialog())
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    MyIni.Write("Last Batch Source", loadPath);
                }
            }
        }

        private void button_batch_select_output_folder(object sender, EventArgs e)
        {
            var fileContent = string.Empty;
            var filePath = string.Empty;
            var MyIni = new IniFile("settings.ini");
            var batch_files_output = MyIni.Read("Last Batch Output");
            ...
            // Feed the dummy name to the save dialog
            sf.FileName = dummyFileName;
            sf.InitialDirectory = batch_files_output;
            ...
            if (sf.ShowDialog() == DialogResult.OK)
            {
                ...
                MyIni.Write("Last Batch Output", savePath);
            }
        }
        private void button_launch_singlefile_conversion(object sender, EventArgs e)
        {
            var MyIni = new IniFile("settings.ini");
